...
void Indie::displayControlsMenu()
{
    ...
    static IndieButton player1Button({middle_x + 300, middle_y + 150, static_cast<float>(player1.getWidth()), static_cast<float>(player1.getHeight())},
                                     {middle_x + 300, middle_y + 150}, player1, loader.textures["player1_highlight"], [&]() -> void
                                     {
        buttonSound.Play();
        this->playerSelected = 0;
        this->state = playerMenu; });

    static IndieButton player2Button({middle_x + 300, middle_y + 250, static_cast<float>(player2.getWidth()), static_cast<float>(player2.getHeight())},
                                     {middle_x + 300, middle_y + 250}, player2, loader.textures["player2_highlight"], [&]() -> void
                                     {
        buttonSound.Play();
        this->playerSelected = 1;
        this->state = playerMenu; });

    static IndieButton player3Button({middle_x + 300, middle_y + 350, static_cast<float>(player3.getWidth()), static_cast<float>(player3.getHeight())},
                                     {middle_x + 300, middle_y + 350}, player3, loader.textures["player3_highlight"], [&]() -> void
                                     {
        buttonSound.Play();
        this->playerSelected = 2;
        this->state = playerMenu; });

    static IndieButton player4Button({middle_x + 300, middle_y + 450, static_cast<float>(player4.getWidth()), static_cast<float>(player4.getHeight())},
                                     {middle_x + 300, middle_y + 450}, player4, loader.textures["player4_highlight"], [&]() -> void
                                     {
        buttonSound.Play();
