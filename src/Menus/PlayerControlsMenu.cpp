...
void Indie::displayPlayerMenu() {
    ...
    static IndieButton doneButton({middle_x + 1000, middle_y + 920, static_cast<float>(done.getWidth()),
                                   static_cast<float>(done.getHeight())},
                                  {middle_x + 1000, middle_y + 920}, done, loader.textures["done_short_highlight"],
                                  [&]() -> void {
                                      buttonSound.Play();
                                      this->state = controlsMenu;
                                  });

    static IndieButton resetKeysButton({middle_x + 300, middle_y + 920, static_cast<float>(resetKeys.getWidth()),
                                        static_cast<float>(resetKeys.getHeight())},
                                       {middle_x + 300, middle_y + 920}, resetKeys,
                                       loader.textures["reset_keys_highlight"], [&]() -> void {
                buttonSound.Play();
                this->players[this->playerSelected].unbindKeys();
            });

    static IndieButton resetLeftButton({middle_x + 1400, middle_y + 250, static_cast<float>(reset.getWidth()),
                                        static_cast<float>(reset.getHeight())},
                                       {middle_x + 1400, middle_y + 250}, reset, loader.textures["reset_highlight"],
                                       [&]() -> void {
                                           buttonSound.Play();
                                           this->players[this->playerSelected].unbindKeyLeft();
                                       });

    static IndieButton resetRightButton({middle_x + 1400, middle_y + 375, static_cast<float>(reset.getWidth()),
                                         static_cast<float>(reset.getHeight())},
                                        {middle_x + 1400, middle_y + 375}, reset, loader.textures["reset_highlight"],
                                        [&]() -> void {
                                            buttonSound.Play();
                                            this->players[this->playerSelected].unbindKeyRight();
                                        });

    static IndieButton resetUpButton({middle_x + 1400, middle_y + 500, static_cast<float>(reset.getWidth()),
                                      static_cast<float>(reset.getHeight())},
                                     {middle_x + 1400, middle_y + 500}, reset, loader.textures["reset_highlight"],
                                     [&]() -> void {
                                         buttonSound.Play();
                                         this->players[this->playerSelected].unbindKeyUp();
                                     });

    static IndieButton resetDownButton({middle_x + 1400, middle_y + 625, static_cast<float>(reset.getWidth()),
                                        static_cast<float>(reset.getHeight())},
                                       {middle_x + 1400, middle_y + 625}, reset, loader.textures["reset_highlight"],
                                       [&]() -> void {
                                           buttonSound.Play();
                                           this->players[this->playerSelected].unbindKeyDown();
                                       });

    static IndieButton resetBombButton({middle_x + 1400, middle_y + 750, static_cast<float>(reset.getWidth()),
                                        static_cast<float>(reset.getHeight())},
                                       {middle_x + 1400, middle_y + 750}, reset, loader.textures["reset_highlight"],
                                       [&]() -> void {
                                           buttonSound.Play();
                                           this->players[this->playerSelected].unbindKeyBomb();
                                       });

    static IndieButton bindLeftButton({middle_x + 1080, middle_y + 250, static_cast<float>(emptyButtonShort.getWidth()),
                                       static_cast<float>(emptyButtonShort.getHeight())},
                                      {middle_x + 1080, middle_y + 250}, emptyButtonShort,
                                      loader.textures["empty_button_short_highlight"], [&]() -> void {
                buttonSound.Play();
    ...
    static IndieButton bindRightButton(
            {middle_x + 1080, middle_y + 375, static_cast<float>(emptyButtonShort.getWidth()),
             static_cast<float>(emptyButtonShort.getHeight())},
            {middle_x + 1080, middle_y + 375}, emptyButtonShort, loader.textures["empty_button_short_highlight"],
            [&]() -> void {
                buttonSound.Play();
    ...
    static IndieButton bindUpButton({middle_x + 1080, middle_y + 500, static_cast<float>(emptyButtonShort.getWidth()),
                                     static_cast<float>(emptyButtonShort.getHeight())},
                                    {middle_x + 1080, middle_y + 500}, emptyButtonShort,
                                    loader.textures["empty_button_short_highlight"], [&]() -> void {
                buttonSound.Play();
    ...
    static IndieButton bindDownButton({middle_x + 1080, middle_y + 625, static_cast<float>(emptyButtonShort.getWidth()),
                                       static_cast<float>(emptyButtonShort.getHeight())},
                                      {middle_x + 1080, middle_y + 625}, emptyButtonShort,
                                      loader.textures["empty_button_short_highlight"], [&]() -> void {
                buttonSound.Play();
    ...
    static IndieButton bindBombButton({middle_x + 1080, middle_y + 750, static_cast<float>(emptyButtonShort.getWidth()),
                                       static_cast<float>(emptyButtonShort.getHeight())},
                                      {middle_x + 1080, middle_y + 750}, emptyButtonShort,
                                      loader.textures["empty_button_short_highlight"], [&]() -> void {
                buttonSound.Play();
