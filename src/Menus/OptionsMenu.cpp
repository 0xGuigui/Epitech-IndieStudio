...
void Indie::displayOptionsMenu() {
    ...
    static IndieButton musicOnButtonObject({middle_x + 300, middle_y + 150, static_cast<float>(musicON.getWidth()),
                                            static_cast<float>(musicON.getHeight())},
                                           {middle_x + 300, middle_y + 150}, musicON,
                                           loader.textures["music_on_highlight"], [&]() -> void {
                buttonSound.Play();
                if (this->_musicPlay) {
    ...
    static IndieButton controlsButtonObject({middle_x + 300, middle_y + 250, static_cast<float>(controls.getWidth()),
                                             static_cast<float>(controls.getHeight())},
                                            {middle_x + 300, middle_y + 250}, controls,
                                            loader.textures["controls_highlight"], [&]() -> void {
                buttonSound.Play();
                this->state = controlsMenu;
            });

    static IndieButton githubButton({middle_x + 300, middle_y + 350, static_cast<float>(github.getWidth()),
                                     static_cast<float>(github.getHeight())},
                                    {middle_x + 300, middle_y + 350}, github, loader.textures["github_highlight"],
                                    [&]() -> void {
                                        buttonSound.Play();
    ...
    static IndieButton helpButtonObject(
            {middle_x + 300, middle_y + 450, static_cast<float>(help.getWidth()), static_cast<float>(help.getHeight())},
            {middle_x + 300, middle_y + 450}, help, loader.textures["help_highlight"], [&]() -> void {
                buttonSound.Play();
                this->state = helpMenu;
            });

    static IndieButton creditsButtonObject({middle_x + 950, middle_y + 150, static_cast<float>(credits.getWidth()),
                                            static_cast<float>(credits.getHeight())},
                                           {middle_x + 950, middle_y + 150}, credits,
                                           loader.textures["credits_highlight"], [&]() -> void {
                buttonSound.Play();
